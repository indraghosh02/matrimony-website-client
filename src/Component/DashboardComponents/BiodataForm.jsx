...
//   const divisions = ["Dhaka", "Chattagram", "Rangpur", "Barisal", "Khulna", "Maymansign", "Sylhet"];
//   useEffect(() => {
//     // Fetch existing biodata of the user
//     fetch(`http://localhost:5000/user/biodata?email=${user.email}`)
...
//   if (existingBiodata) {
//     // Render existing biodata
//     return (
//       <div className="flex items-center justify-center min-h-screen bg-white">
//         <div className="w-full max-w-3xl p-8 space-y-6 bg-white rounded-lg shadow-md">
//           {/* Render existing biodata here */}
//           <h2 className="text-2xl font-bold text-center text-gray-700">Your Existing Biodata</h2>
//           {/* Render existing biodata fields */}
//         </div>
//       </div>
//     );
//   }

//   // Render biodata form if user doesn't have existing biodata
//   return (
//     <div className="flex items-center justify-center min-h-screen bg-white">
//       <div className="w-full max-w-3xl p-8 space-y-6 bg-white rounded-lg shadow-md">
